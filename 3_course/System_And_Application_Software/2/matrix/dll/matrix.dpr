...
function SubtractMatrices(matrix1, matrix2: ddm; row: Integer; column:integer):ddm; stdcall;
var
  i, j: Integer;
begin
  for i := 0 to row-1 do
...
function MultiplyMatrices(matrix1, matrix2:ddm; row1,col1,row2,col2: Integer):ddm;stdcall;
  var i, j, k: Integer;
      result1:ddm;
begin
  setlength(result1,row1,col2);
...
function RotateMatrix(a: ddm; n: integer; m:integer; clockwise: boolean): ddm; stdCall;
var
  i, j: integer;
  res: ddm;
begin
...
exports RotateMatrix,RankOfMatrix,ReadMatrixByCorners,WriteMatrixByCorners,ArrayToSpiralMatrix,SortMatrixRow,SpiralMatrixToArray,InverseMatrix,ConjugateMatrix,MultiplyMatrices,SubtractMatrices,AddMatrices,SortMatrixCol,Determinant,TransposeMatrix;
begin
end.
